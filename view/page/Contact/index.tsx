              ...
              <div className='grid grid-col-1 md:grid-cols-2 gap-5'>
                <div>
                  ...
                  <div className=''>
                    ...
                    <div className='py-1 '>
                      ...
                      <div className='py-1'>
                        ...
                        <span className='text-zinc-500 text-base font-normal  underline'>
                          linkedin/<br/>shihab-uddin-chowdury
                        </span>
                      </div>
                      <div className='py-1'>
                    ...
                    <div className='text-zinc-500 text-base lg:text-xl font-normal underline py-3'>cshihab04@gmail.com</div>
                  </div>
                </div>
                <div>
                  <Image
                  ...
                  <div className='text-zinc-500 text-base lg:text-xl font-normal underline py-3'>pavlina@thesrii.org</div>
                </div>
              </div>
            </div>
          </div>
