    ...
    <div className='bg-[#29323D] relative z-10'>
      ...
      <div className='  max-w-[1356px] mx-auto pt-[100px] pb-[100px]'>
        <div className='flex gap-[16px] pt-[60px] items-center'>
          ...
          <IoIosArrowForward color={'white'} />
          <p className='text-white text-[16px] font-medium'>Asia Summit 2013</p>
        </div>
        <h2 className='text-[#FFF] capitalize text-2xl md:text-4xl lg:text-[50px] font-semibold pl-[0px]  pt-[30px]'>
        The 1st SRII Asia Summit, 2013 in Bangkok,Thailand
        </h2>
        ...
        <p className='pt-[50px] text-white '>
          ...
          <Link href= 'http://naist.cpe.ku.ac.th/SRII2013/program.php' className='hover:font-bold '>
          http://naist.cpe.ku.ac.th/SRII2013/program.php{' '}
          </Link>
        </p>
        ...
        <div className='z-[100] pt-[85px] max-w-[1356px] mx-auto'>
          <div className='grid grid-cols-2 gap-x-[30px]'>
            <div className=''>
              <Image
                src='/image/summits_page/summits_asia/1.png'
                width={1000}
                height={1000}
            ...
            <div className='  '>
              <Image
                src='/image/summits_page/summits_asia/2.png'
                width={1000}
                height={1000}
                className='w-full h-full object-cover'
                alt='summit'
          ...
          <div className='pt-[30px]'>
            <Image
              src='/image/summits_page/summits_asia/3.png'
              width={1350}
              height={542}
              className='w-full h-full object-cover'
              alt='summit'
          ...
          <div className='pt-[30px] grid grid-cols-12 gap-x-[30px]'>
            <div className='col-span-9 '>
              <Image
                src='/image/summits_page/summits_asia/4.png'
                width={1005}
                height={420}
                className='w-full h-full object-cover'
                alt='summit'
            ...
            <div className='col-span-3 '>
              <Image
                src='/image/summits_page/summits_asia/5.png'
                width={327}
                height={420}
                className='w-full h-full object-cover'
                alt='summit'
          ...
          <div className='pt-[30px] '>
            <Image
              src='/image/summits_page/summits_asia/6.png'
              width={1350}
              height={929}
              className='w-full h-full object-cover'
              alt='summit'
        ...
        <Link href='https://www.flickr.com/photos/128066616@N06/albums/72157649180227548/' target='_blank' className='pt-8 md:pt-10 lg:pt-14  pb-2 md:pb-2 lg:pb-2.5 flex justify-end items-center'>
          <div
